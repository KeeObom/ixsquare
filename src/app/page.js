            ...
            <div className="flex flex-wrap items-end justify-between gap-6">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm text-muted-foreground">
                  Real experiences from clients we’ve supported across education, visa guidance, travel planning, and flight bookings.
                </p>
              </div>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              {testimonials.map((t) => (
                ...
                >
                  ...
                  <div className="mt-5 h-px w-full bg-gradient-to-r from-transparent via-accent/50 to-transparent" />

                  <div className="mt-4 text-sm font-semibold text-foreground">{t.name}</div>
                  <div className="mt-1 text-xs text-muted-foreground">Verified client feedback</div>
                </div>
              ))}
            </div>

            <div className="mt-6 rounded-3xl border border-border bg-zinc-50 p-6">
              <div className="text-sm font-semibold text-foreground">Have we helped you before?</div>
              <p className="mt-2 text-sm text-muted-foreground">
                Share your experience — it takes 1–2 minutes and helps others make confident decisions.
              </p>
