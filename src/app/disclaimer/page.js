    ...
    return (
      <main className="bg-white">
        <section className="mx-auto max-w-6xl px-4 py-14">
          ...
          <div className="mt-8 max-w-3xl rounded-3xl border border-border bg-zinc-50 p-7 text-sm text-zinc-700">
            <p>
              <span className="font-semibold text-foreground">
                DiAnixSquare International Agency
              </span>{" "}
              provides advisory and support services only. Visa, admission,
              permanent residence, and citizenship decisions are made solely by
              relevant authorities and institutions.
            </p>
  
            <p className="mt-4">
              We do not influence outcomes and we do not guarantee approvals. All
              applications are assessed strictly based on eligibility,
              documentation, and decisions by relevant authorities.
            </p>
  
            <p className="mt-4">
              Information and guidance provided by DiAnixSquare is intended to
              support clients in understanding processes and requirements. Clients
              remain responsible for the accuracy and completeness of information
              submitted in any application.
            </p>
  
            <div className="mt-6 rounded-2xl border border-accent/25 bg-white p-4">
